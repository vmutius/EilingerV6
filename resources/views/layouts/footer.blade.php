<footer id="footer">
    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 footer-links">
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('impressum') }}">Impressum</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('datenschutz') }}">Datenschutzerklärung</a></li>
            </ul>
        </div>
