    ...
    <section id="contact" class="contact">
        <div class="container">
            ...
            <p> Sie brauchen für Ihr Projekt oder Ihre berufliche Ausbildung finanzielle Unterstützung? Hier können
                Sie Ihre Förderanfrage an die Eilinger Stiftung Schweiz stellen. </p>
            ...
            <p> Ich erstelle ein Benutzerkonto für mich als <strong><a
                        href="{{ route('register_privat') }}">Privatperson</a></strong> (für ein Stipendiengesuch
                bitte diese Option wählen)
                ODER ich erstelle das Benutzerkonto für <strong><a href="{{ route('register_inst') }}">einen
                        Verein/eine Institution </a></strong>.</p>
            </br>
            </br>
